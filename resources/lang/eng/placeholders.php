...
return array(
    ...
    'storageSetting' => array(
        'awsKey' => 'e.g. AWS_KEY_PLACEHOLDER',
    ...
    'paymentGateway' => array(
        'sandboxPaypalClientId' => 'e.g. PAYPAL_SANDBOX_CLIENT_ID_PLACEHOLDER',
        'livePaypalClientId' => 'e.g. PAYPAL_LIVE_CLIENT_ID_PLACEHOLDER',
        'testStripePublishableKey' => 'e.g. STRIPE_TEST_PUBLISHABLE_KEY_PLACEHOLDER',
        'liveStripePublishableKey' => 'e.g. STRIPE_LIVE_PUBLISHABLE_KEY_PLACEHOLDER',
        'testRazorpayKey' => 'e.g. RAZORPAY_TEST_KEY_PLACEHOLDER',
        'liveRazorpayKey' => 'e.g. RAZORPAY_LIVE_KEY_PLACEHOLDER',
        'paystackKey' => 'e.g. PAYSTACK_KEY_PLACEHOLDER',
        'flutterwaveKey' => 'e.g. FLUTTERWAVE_KEY_PLACEHOLDER',
    ),
    'bankaccount' => array(
    ...
    'recaptchaV2' => 'e.g. RECAPTCHA_KEY_PLACEHOLDER',
    'recaptchaSecret' => 'e.g. RECAPTCHA_SECRET_PLACEHOLDER',
    'recaptchaV3' => 'e.g. RECAPTCHA_KEY_PLACEHOLDER',
